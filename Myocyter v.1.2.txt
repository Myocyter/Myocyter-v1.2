...
Dialog.create("Please choose...");
  Dialog.addChoice("Select:", newArray("1. Pretest (for size and threshold)", "2. Create a Batch List", "3. Evaluation", "4. Exclude Data", "5. Re-Evaluation", "6. Data Extraction"));
